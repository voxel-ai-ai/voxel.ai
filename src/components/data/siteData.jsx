...
export const communityFeed = [
  { id: 20, type: 'image', creator: 'you', views: '0', likes: '0', model: 'Nano Banana Pro', imageUrl: 'https://media.base44.com/images/public/69a83da7490a426a3f30f581/af01f98cd_ChatGPTImageMar25202605_10_35PM.png', prompt: 'Colossal ancient dragon with bioluminescent blue eyes descends through a rain-soaked dystopian city canyon, massive wingspan spanning the full width of a six-lane boulevard, dark storm clouds and volumetric fog rolling between brutalist concrete towers, cars scattered on wet asphalt reflecting pale blue light, extreme low-angle hero shot, anamorphic lens distortion, Unreal Engine 5 photorealism, cinematic color grade, 8K' },
