...
export const communityFeed = [
  ...
  { id: 9, type: 'image', creator: 'you', views: '0', likes: '0', model: 'Veo 3.1', imageUrl: 'https://media.base44.com/images/public/69a83da7490a426a3f30f581/d7e345e5c_0_01.jpg', prompt: 'Astronaut in space taking a photo with a smartphone, cinematic lighting, photorealistic' },
  { id: 10, type: 'image', creator: 'you', views: '0', likes: '0', model: 'Veo 3.1', imageUrl: 'https://media.base44.com/images/public/69a83da7490a426a3f30f581/dfe592984_1c9f0e5b-96cc-416e-b5a9-a94efbeede19.png', prompt: 'Fantasy villain character with white hair and glowing yellow eyes, cinematic close-up, photorealistic' },
  { id: 11, type: 'image', creator: 'you', views: '0', likes: '0', model: 'Veo 3.1', imageUrl: 'https://media.base44.com/images/public/69a83da7490a426a3f30f581/bba45636f_6e354a1a-fa83-4c61-a033-e9755dd40b6a.png', prompt: 'Action Santa Claus rescuing a child from a burning building, cinematic, dramatic lighting' },
  { id: 12, type: 'image', creator: 'you', views: '0', likes: '0', model: 'Veo 3.1', imageUrl: 'https://media.base44.com/images/public/69a83da7490a426a3f30f581/425c55211_54eeba81-1a47-406c-9f86-f4205743fcf3.png', prompt: 'Santa Claus in a convenience store holding a candy cane, cinematic scene, photorealistic' },
